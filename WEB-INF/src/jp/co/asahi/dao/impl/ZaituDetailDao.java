...
@ManagedBean(name = "zaituDetailDao")
@ApplicationScoped
public class ZaituDetailDao extends DaoAdapter {
	...
	public int selectGoodsCount(Timestamp zaituDate, String barcode) throws SQLException {

		StringBuffer sql = new StringBuffer();
		sql.append("SELECT count FROM v_zaitu_detail where zaitu_date=? AND goods_barcode=? \n");
